<div class="w-full pt-10 h-fit">
    ...
    <div class="text-center bg-[#FAF8F3]">
        <a href="/product-detail/singlet">
            <p class="font-medium text-sm">Signature Detergent Classic</p>
            <p class="text-xs">Detergent for Everyday Laundering</p>
        </a>
        ...
        <div class="w-full p-2">
            <button class="w-full flex justify-between items-center bg-[#BFCBC6] border border-[#000] text-sm font-medium p-2">
                <p>Add to Bag</p>
                <p>₦26,000</p>
            </button>
